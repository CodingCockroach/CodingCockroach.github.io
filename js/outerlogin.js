...
function writeLoginPanel(b){
	...
	var e='return checkInput()',
	    c='<div id="bg" class="bizmail_loginpanel"></div><div id="about" class="bizmail_LoginBox"><img id="about-picture" src="/img/favicon.ico"/><img id="about-close" src="/img/close.png" onclick="hidediv();"/><h4 id="about-name">@CodingCockroach.com</h4><div id="login"><form name="form1" action="https://exmail.qq.com/cgi-bin/login" target="_blank" method="post" onsubmit="'+e+'"><input type="hidden" name="firstlogin" value="false" /><input type="hidden" name="errtemplate" value="dm_loginpage" /><input type="hidden" name="aliastype" value="other" /><input type="hidden" name="dmtype" value="bizmail" /><input type="hidden" name="p" value="" /><span class="fontawesome-user"></span><input type="text" id="user" name="uin" placeholder="Username" class="text" value="" /><input type="hidden" name="domain" value="codingcockroach.com" /><span class="fontawesome-lock"></span><input type="password" name="pwd" id="pass" placeholder="Password" class="text" value="" /><input type="submit" class="" name="" value="Login" />&nbsp;</form><a href="https://exmail.qq.com/cgi-bin/readtemplate?check=false&t=bizmail_orz" target="_blank" class="lnk"><span class="icon icon--min">ಠ╭╮ಠ</span>I have forgotten something</a></div></div>',
